...
public class kafkaIgniteStreamer {
     ...
     * Ignite config file.
     */
    private static final String CONFIG = "/opt/spark/examples/jars/example-kube-rbac.xml";

    /**
     * Test cache name.
     */
    private static final String CACHE_NAME = "testCache001";
    ...
    private static void writeJSonToIgnite(Ignite ignite, SparkSession spark) {
        ...
        List<List<?>> data = cache.query(new SqlFieldsQuery("SELECT id, name, city_id FROM person")).getAll();
